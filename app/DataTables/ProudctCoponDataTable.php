...
class ProudctCoponDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->editColumn('pharmciyes', function ($cuisine) {
             ...
             return $cuisine->pharmciyes[0]['name'];
            })
            ...
            ->addColumn('action', 'proudct_copons.datatables_actions')
     ...
     */
    public function query(ProudctCopon $model)
    {
    ...
    protected function getColumns()
    {
        ...
        $hasCustomField = in_array(ProudctCopon::class, setting('custom_field_models',[]));
        if ($hasCustomField) {
            $customFieldsCollection = CustomField::where('custom_field_model', ProudctCopon::class)->where('in_table', '=', true)->get();
            foreach ($customFieldsCollection as $key => $field) {
                array_splice($columns, $field->order - 1, 0, [[
                    'data' => 'custom_fields.' . $field->name . '.view',
                    'title' => trans('lang.proudct_copon_' . $field->name),
                    'orderable' => false,
                    'searchable' => false,
                ]]);
            }
    ...
    {
        return 'proudct_coponsdatatable_' . time();
    }
