        ...
        try {
            if ($request->has('device_token')) {
                ...
                if($request->hasFile('avatar') && $request->file('avatar')->isValid()) {
                    ...
                    $input['uuid']= Str::uuid();
                    $client = Upload::create($input);
                   // if (isset($input['avatar']) && $input['avatar'])
                    {
                       // $client->addMediaFromRequest('avatar')->toMediaCollection('avatar');
                        $client->addMedia($input['avatar'])
                            ->withCustomProperties(['uuid' => $input['uuid'], 'user_id' => $id])
                ...
                foreach (getCustomFieldsValuesex($customFields, $input['user']) as $value) {
