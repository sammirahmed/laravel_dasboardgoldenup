...
Route::get('payments/urway/express-checkout', 'URWAY@getExpressCheckout')->name('urway.express-checkout');
Route::get('payments/urway/express-checkout-success', 'URWAY@getExpressCheckoutSuccess')->name('urway.callback');;
...
Route::middleware('auth')->group(function () {
    ...
    Route::group(['middleware' => ['permission:app-settings']], function () {
        Route::prefix('settings')->group(function () {
            ...
            Route::post('sendsms', 'AppSettingController@sendMessage');
    ...
    Route::post('mainCategorie/remove-media', 'MainCategorieController@removeMedia');

     Route::post('subCategorie/remove-media', 'SubCategorieController@removeMedia');
    Route::post('airplan/remove-media', 'airplanController@removeMedia');
    Route::post('brand/remove-media', 'brandController@removeMedia');
    Route::post('pharmcy/remove-media', 'pharmcyController@removeMedia');
    Route::post('campagin/remove-media', 'CampaginController@removeMedia');
    ...
    Route::post('pruducts/remove-media','PruductController@removeMedia');
    Route::post('pruductcopon/remove-media','ProudctCoponController@removeMedia');

    Route::resource('slides', 'SlideController')->except([
        'show'
    ]);

    Route::resource('proudctCopons', 'ProudctCoponController');

    Route::resource('discounttypes', 'DiscounttypeController');
...
//Route::resource('brands', 'BrandsController');
    ...
    Route::resource('mainCategories', 'MainCategorieController');

    Route::resource('subCategories', 'SubCategorieController');

    Route::resource('pruducts', 'PruductController');

    Route::resource('brands', 'BrandController');

    Route::resource('pharmcies', 'PharmcyController');

    Route::resource('extraGroupProuducts', 'ExtraGroupProuductController');

    Route::resource('storgePharms', 'StorgePharmController');

    Route::resource('extraPruducts', 'ExtraPruductController');

    Route::resource('productReviews', 'ProductReviewsController');
    Route::resource('campagins', 'CampaginController');
});
...
Route::resource('airplans', 'airplanController');
...
Route::group([],function() {
    Route::get('myfatoorah', 'MyFatoorahController@index')->name('myfatoorah.index');
    Route::get('myfatoorah/callback', 'MyFatoorahController@callback')->name('myfatoorah.callback');
});


Route::get('pack/getnumday', 'SubscriptionController@getamout')->name('pak.numday');
