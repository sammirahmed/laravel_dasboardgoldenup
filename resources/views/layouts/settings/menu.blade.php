 ...
 ? '' : 'collapsed-card' }}">
    ...
    <div class="card-body p-0">
        <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item">
                <a href="{!! url('settings/app/actions') !!}" class="nav-link {{  Request::is('settings/app/actions*') ? 'selected' : '' }}">
                    <i class="fa fa-cog"></i> {{trans('lang.app_setting_globals')}}
                </a>
            </li>
            ...
            <li class="nav-item">
                <a href="{!! url('settings/sms/builder') !!}" class="nav-link {{  Request::is('settings/sms*') ? 'selected' : '' }}">
                    <i class="fa fa-credit-card"></i> {{trans('SMS Builder')}}
                </a>
            </li>
