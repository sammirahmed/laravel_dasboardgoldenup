        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <!-- Theme Color Field -->
                 ...
                 [
                 'empty' => trans('فارغة'),
                 'category' => trans('الاقسام'),
                 'onebyone' => trans('عروض ١+١'),
                 'offer' => trans('عروض مميزة'),
                 'percent' => trans('عروض الخصم'),
                 'sub' => trans('قسم خاص'),

                 ]
                 ,    setting('home_section_'.$i,'empty')
                 , ['class' => 'select2 form-control']) !!}
                    ...
                    <div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
                        <!-- Category Id Field -->
                        <div class="form-group row ">
                            {!! Form::label('category_id', trans("الاقسام"),['class' => 'col-3 control-label text-right']) !!}
                            <div class="col-9">
                                {!! Form::select('home_sectionh_'.$i, $restaurant,  setting('home_sectionh_'.$i,'random'), ['class' => 'select2 form-control']) !!}
                                <div class="form-text text-muted">{{ trans("اختر القسم") }}</div>
                            </div>
                        </div>
                 </div>
