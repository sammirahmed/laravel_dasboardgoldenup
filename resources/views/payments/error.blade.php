    ...
    <div style="flex: 100%;max-width: 100%;padding: 0 4px;" class="row" >
      ...
      <div class="bg">
        ...
        <div class="card">
          ...
          <span class="card__success"><i class="fa fa-times-circle-o"></i></span>

          <h1 class="card__msg">Payment Failure</h1>
          <h2 class="card__submsg">Oops! Something went wrong.</h2>
          <h2 class="card__submsg">While trying to reserve money from your account</h2>
