...
<!-- Google Font: Poppins /Library/WebServer/Documents/PHPProject/laravel_dasboardgolden/public/plugins/PricingSubscription -->
    ...
    <link href="{{asset('plugins/PricingSubscription/css/style.css')}}" rel="stylesheet" type="text/css" media="all"/>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    <link href="https://fonts.googleapis.com/css?family=Monda" rel="stylesheet">

    <script src="{{asset('plugins/PricingSubscription/js/jquery-1.11.0.min.js')}}"></script>
    <script src="{{asset('plugins/PricingSubscription/js/jquery.magnific-popup.js')}}" type="text/javascript"></script>
    <script src="{{asset('plugins/PricingSubscription/js/jquery.validate.min.js')}}" type="text/javascript"></script>
    <script>
